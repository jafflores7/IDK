...
class Tool {
    ...
    setupExpressApp() {
        ...
        this.app.use(express__default.default.json({ limit: '10mb' }));
        this.app.use(express__default.default.urlencoded({ extended: true, limit: '10mb' }));
    ...
    applyRateLimiting() {
        if (this.config.rateLimit) {
            const limiter = rateLimit__default.default({
